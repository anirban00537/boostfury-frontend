      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-24">
        <div className="text-center space-y-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-neutral-900">
              Create{" "}
              ...
              <br />
              <span className="text-4xl sm:text-5xl lg:text-6xl text-neutral-800">
                for LinkedIn
              </span>
            </h1>
