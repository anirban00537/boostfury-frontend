    ...
    <div>
      ...
      <div className="px-4">
        <div className="relative group">
          ...
          <div className="relative p-4 rounded-xl bg-gradient-to-br from-white/95 via-primary/5 to-blue-600/5 backdrop-blur-xl border border-white/30 shadow-lg shadow-primary/10 transition-all duration-300 group-hover:shadow-xl group-hover:border-primary/30">
            {/* Plan Header */}
            <div className="flex items-center gap-3">
              <div className="relative size-10 rounded-xl bg-gradient-to-br from-primary/20 to-blue-600/20 flex items-center justify-center shrink-0 shadow-inner group-hover:scale-105 transition-transform duration-300">
                <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-primary/20 via-blue-600/20 to-violet-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            ...
            <div className="mt-4 space-y-3">
              ...
              {subscription?.subscription?.isTrial && (
                <div className="py-2 px-3 rounded-lg bg-gradient-to-br from-amber-500/5 via-orange-500/5 to-red-500/5 border border-amber-500/10">
              ...
              <Link href="/pricing" className="block mt-4">
                <GradientButton
                  ...
                  size="sm"
                  fullWidth
                  className="shadow-lg shadow-primary/10 hover:shadow-xl hover:shadow-primary/20 transition-all duration-300 hover:-translate-y-0.5 group"
                >
