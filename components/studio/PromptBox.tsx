      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex-1 min-h-[20px] relative group">
          <textarea
            ...
            className="w-full h-[52px] text-[15px] leading-relaxed bg-transparent border-none focus:outline-none resize-none placeholder:text-neutral-400/80 text-neutral-600 scrollbar-none"
